...
<form name="f2" action="diag1.php" method="post" style="color:black; float:center; padding-right:20px; padding-left:20px;" >
<h1  style=" background-color:#3528f685; text-align:center;">EMPLOYEE DIAGNOSTICS</h1>
     <p style=" background-color:black;">Please fill the password to login to diagnostics.</p>
    <hr><br>
